...
class ChatMessageCell : UITableViewCell {
    ...
    struct Appearance {
        ...
        static var font: UIFont = UIFont.systemFont(ofSize: 17)
    }
    ...
    public lazy var opponentImageView: UIImageView = {
        ...
        opponentImageView.center =  CGPoint.init(x: self.padding + halfWidth, y: textViewSingleLineCenter)
...
class ChatController : UIViewController, UITableViewDelegate, UITableViewDataSource, ChatInputDelegate {
    ...
    private let chatInput = ChatInput(frame: CGRect.zero)
    ...
    private func listenForKeyboardChanges() {
        ...
        defaultCenter.addObserver(self,
                                  selector: #selector(ChatController.keyboardWillChangeFrame(note:)),
...
//                                  object: nil)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "identifier", for: indexPath as IndexPath) as! ChatMessageCell
...
class ChatInput : UIView, StretchyTextViewDelegate {
    ...
    public let textView = StretchyTextView(frame: CGRect.zero, textContainer: nil)
    private let sendButton = UIButton.init(type: .system)
    ...
    func setupTextView() {
        ...
        textView.center = CGPoint.init(x: self.bounds.midX, y: self.bounds.midY)
        self.styleTextView()
    ...
    func setupSendButton() {
        ...
        self.sendButton.addTarget(self, action: #selector(ChatInput.sendButtonPressed(sender:)), for: .touchUpInside)
    ...
    func stretchyTextViewDidChangeSize(chatInput textView: StretchyTextView) {
...
@objc protocol StretchyTextViewDelegate {
    ...
    func stretchyTextViewDidReturn(textView: StretchyTextView)
    @objc optional func stretchyTextView(textView: StretchyTextView, validityDidChange isValid: Bool)
}
...
class StretchyTextView : UITextView, UITextViewDelegate {
    ...
    func textView(textView: UITextView, shouldChangeTextInRange range: NSRange, replacementText text: String) -> Bool {
        ...
        stretchyTextViewDelegate?.stretchyTextViewDidReturn(textView: self)
        return false
    }
